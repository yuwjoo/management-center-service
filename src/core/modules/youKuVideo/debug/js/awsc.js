...
let locationHost = "v.youku.com";
let locationPathname = "v.youku.com";
!function(e, t) {
    var n = 1e4
      , g_moduleConfig = {
        uabModule: {
    ...
    function U(e) {
        ...
        ;
        function t(t, n, o, a) {
            var r = locationProtocol + "//" + locationHost + locationPathname
              , i = new e.AWSCFY;
            e._umopt_npfp = 0;
            var s = !1;
    ...
    function D(e) {
        ...
        ;
        function n(n, o, a) {
            var r = (locationProtocol + "//" + locationHost + locationPathname).substr(0, 128)
              , i = new t;
            if (a = a || 2e3,
            "function" == typeof n)
    ...
    function E(e) {
        ...
        r.test(locationHost + locationPathname) && (window.etrprtrt = .01,
        e.AWSC.use("et"))
    }
    function x(e) {
        e.AWSC || (e.AWSC = {},
